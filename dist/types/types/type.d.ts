...
type Dossier = {
    ...
    lst_technicien?: UserResponse[];
};
export type { User, DecodedToken, Role, RoleCreate, Privilege, UserResponse, AvisClient, Intervention, Fourniture_envoye, Fluide_Caloporteur, Horaire_Pointage, Utilisation_Fourniture, Kit_fourniture, Dossier };
